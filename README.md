...
For your storage device under Disk drives, Turn off write-cache buffer flushing by going into Properties -> Policies<br>
...
Some of these settings might be already set in the BIOS, however I've seen a lot of strange behaviour in Windows regarding clock speeds and power saving features changing without a clear explanation.<br>
   ...
   - Disable xHCI IMOD on your device for lower latency. Replace BAR1 with your own BAR1 from RWEverything and replace the four digits at the end.<br>
